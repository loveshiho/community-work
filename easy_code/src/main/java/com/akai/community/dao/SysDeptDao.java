package com.akai.community.dao;

import com.akai.community.entity.SysDept;
...
public interface SysDeptDao {
     ...
     * @return 对象列表
     */
    List<SysDept> queryAllByLimit(SysDept sysDept, @Param("pageable") Pageable pageable);
